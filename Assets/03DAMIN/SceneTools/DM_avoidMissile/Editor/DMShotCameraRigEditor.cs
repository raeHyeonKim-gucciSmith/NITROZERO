...
public sealed class DMShotCameraRigEditor:Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        EditorGUILayout.HelpBox("카메라 10개 / Main Camera 1개. 01·02는 고정, 나머지는 대상 추적. 첫 두 장면은 Play 시 01→02 자동 전환합니다. 03 이후 연출은 아직 연결하지 않았습니다.",MessageType.Info);
        ...
        EditorGUILayout.HelpBox("01·02: 각 CM_Shot의 Transform으로 고정 위치/방향 조절. 나머지: Shots > Position Offset / Aim Offset. 화각: CM_Shot > Lens. 정지 상태에서는 구도 버튼을 다시 눌러 반영하세요. Play 중 수정은 종료 시 되돌아갑니다.",MessageType.None);
    }
}
