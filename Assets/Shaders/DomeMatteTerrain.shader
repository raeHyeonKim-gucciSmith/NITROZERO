Shader "NITRO ZERO/Terrain/Matte Lunar"
{
    Properties
    {
    ...
    // Lunar regolith is a diffuse surface: retain light color and shadows, but
    // remove both direct specular highlights and sky/probe reflections.
    ...
    Dependency "AddPassShader" = "Hidden/NITRO ZERO/Terrain/Matte Lunar (Add Pass)"
    Dependency "BaseMapShader" = "Hidden/NITRO ZERO/Terrain/Matte Lunar (Base Pass)"
