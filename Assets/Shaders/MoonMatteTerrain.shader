Shader "NITROZERO/Moon Matte Terrain"
{
    Properties
    {
    ...
    HLSLINCLUDE
    // Keep diffuse terrain lighting and shadows, but suppress all specular glints.
    ...
    Dependency "AddPassShader" = "Hidden/NITROZERO/Moon Matte Terrain (Add Pass)"
    Dependency "BaseMapShader" = "Hidden/NITROZERO/Moon Matte Terrain (Base Pass)"
